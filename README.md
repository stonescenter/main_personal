...
> **Note:** This repository acts as the central hub for my doctoral research, while individual projects, papers, and implementations are maintained in dedicated repositories to improve organization, reproducibility, and long-term maintenance.
...
|---------|--------|-------------|-------------|--------------|
| **[ATLaS](https://github.com/stonescenter/atlas)** | Nothing | Learning Multi-task objetives with transition policies on Dynamic Graphs | 🚧 Active | Working
| **[STaRW](https://github.com/stonescenter/paper_bracis2026)** | BRACIS| Learning Spatiotemporal constraints with a degree-normalized walks | 🚧 Active | Submitted
...
# 💻 Other Projects and Colaborations
